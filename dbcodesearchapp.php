<?php
	...
	$search_q = "SELECT `app_id`, `app_date`, `app_time`, `app_doctor`, `app_patient`,`app_fees` from appointment  WHERE   app_doctor LIKE '%".$afname."%' or app_patient LIKE '%".$afname."%' ";
					...
					<div class="panel-body">
                        ...
                        <table data-toggle="table"   data-show-refresh="true" data-show-toggle="true" data-show-columns="true"  data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <thead>
						        ...
						        <th   data-sortable="true">Appointment Date</th>
						        <th  data-sortable="true">Appointment Time</th>
                                 <th   data-sortable="true">Appointment Doctor</th>
                                 <th   data-sortable="true">Appointment Patient</th>
                                <th   data-sortable="true">Appointment Fees</th>
                        ...
                        <?php
                           ...
                           <tr>
                            ...
                            <?php 
						      ...
						      echo "<td>".$row['app_id']."</td>&nbsp&nbsp&nbsp&nbsp";
                              
                                
                    
						      echo "<td>".$row['app_date']."</td>&nbsp&nbsp&nbsp&nbsp";
                    
                         
                        
                    
						      echo "<td>".$row['app_time']."</td>&nbsp&nbsp&nbsp&nbsp";
                                                                      
                              echo "<td>".$row['app_doctor']."</td>&nbsp&nbsp&nbsp&nbsp";
                        
                              echo "<td>".$row['app_patient']."</td>&nbsp&nbsp&nbsp&nbsp";
                                echo "<td>".$row['app_fees']."</td>&nbsp&nbsp&nbsp&nbsp";
					            echo "</tr>"; 
							?>        
