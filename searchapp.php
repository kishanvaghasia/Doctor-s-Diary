			...
			<div class="col-lg-12">
				<div class="panel panel-default">
                    ...
                    <div class="form-group">
                        <form action="dbcodesearchapp.php" method="post">
									<label style="font-size:20px">Search Patient Firstname Or Doctor Firstname:</label>
									<input class="form-control" placeholder="Enter Patient Firstname Or Doctor Firstname" name="afname" required autofocus="">
