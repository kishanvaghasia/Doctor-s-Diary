<?php
	...
	$search_q = "SELECT * FROM `appointment` WHERE app_date >= '".$rstart."' and app_date <= '".$rend."'";

	//$search_q = "SELECT  * FROM `patient_master` WHERE patient_registrationdate  >= '%".$rstart."%' and patient_registrationdate <= '%".$rend."%' ";
