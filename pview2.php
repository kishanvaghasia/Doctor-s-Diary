                    ...
                    <table data-toggle="table" data-search="true"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true"  data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
						       ...
						       <th  data-sortable="true">ID</th>
                                ...
                                <th  data-sortable="true">Treatment Name</th>
                                <th  data-sortable="true">Treatment fee</th>
                                <th  data-sortable="true">Medicine</th>
						    </tr>
						    </thead>
                        ...
                        <td>
                            <?php echo $std->treatment_name; ?>
                        </td>
                        <td>
                            <?php echo $std->treatment_fee; ?>
                        </td>
                        <td>
                            <?php echo $std->medicine; ?>
                        </td>
