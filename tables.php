...
session_start();
	...
	$search_q = "SELECT `patient_id`, `patient_fname`, `patient_mname`, `patient_lname`, `patient_dob`, `patient_gender`, `patient_identity_number`, `patient_caste`, `patient_religion`, `patient_address`, `patient_phonenumber`, `patient_zipcode`, `patient_emailaddress`, `patient_state`, `patient_registrationdate`, `patient_category`, `name_of_kim`, `patient_bloodgroup` FROM `patient_master` WHERE patient_fname LIKE '%".$pfname."%' ";
	
	$result = mysqli_query($con,$search_q);
	$search_cnt = mysqli_num_rows($result);
                       ...
                       <tbody>    
                        <?php
                            ...
                            <?php 
						      ...
						      echo "<td>".$row['patient_id']."</td>&nbsp&nbsp&nbsp&nbsp";
                              
                                
                    
						      echo "<td>".$row['patient_fname']."</td>&nbsp&nbsp&nbsp&nbsp";
                    
                         
                        
                    
						      echo "<td>".$row['patient_lname']."</td>&nbsp&nbsp&nbsp&nbsp";
							 echo "<td>"; ?><a href='pview2.php?id=<?php echo $row['patient_id']; ?>'>&nbsp;&nbsp;<svg  width="20" height="20" ><use xlink:href="#stroked-monitor"/></svg></a> <?php echo "</td>";
