			...
			<div class="col-lg-12">
				<div class="panel panel-default">
                    ...
                    <table data-toggle="table" data-search="true"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true"  data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                        ...
                        <td>
                            <a href='update2.php?id=<?php echo $std->patient_id; ?>'>&nbsp;&nbsp;<svg  width="20" height="20" ><use xlink:href="#stroked-pencil"/></svg></a>  
                        <a href='update2.php?id=<?php echo $std->patient_id; ?>&action=delete'>&nbsp;&nbsp;<svg  width="20" height="20"><use xlink:href="#stroked-trash"/></svg></a> 
