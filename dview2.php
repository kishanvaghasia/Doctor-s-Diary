                    ...
                    <table data-toggle="table" data-search="true"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true"  data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
						       ...
						       <th  data-sortable="true">ID</th>
                                ...
                                <th  data-sortable="true">Name of Degree</th>
                                <th  data-sortable="true">Instiution</th>
                                
                                <th  data-sortable="true">Year Graduated</th>
                        ...
                        <tr>
                         <td>
                            <?php echo $std->doctor_id; ?>
                        </td>
                            
                       
                        <td>
                            <?php echo $std->first_name; ?>
                        </td>
                        <td>
                            <?php echo $std->middle_name; ?>
                        </td>
                        <td>
                            <?php echo $std->last_name; ?>
                        </td>
                        <td>
                            <?php echo $std->date_of_birth; ?>
                        </td>
                        <td>
                            <?php echo $std->gender; ?>
                        </td>
                        <td>
                            <?php echo $std->reg_id_number; ?>
                        </td>
                        <td>
                            <?php echo $std->caste; ?>
                        </td>
                        <td>
                            <?php echo $std->religion; ?>
                        </td>
                        <td>
                            <?php echo $std->address; ?>
                        </td>
                        <td>
                            <?php echo $std->phone_number; ?>
                        </td>
                        <td>
                            <?php echo $std->zipcode; ?>
                        </td>
                        <td>
                            <?php echo $std->email_address; ?>
                        </td>
                        <td>
                            <?php echo $std->state; ?>
                        </td>
                        <td>
                            <?php echo $std->name_of_degree ?>
                        </td>
                         <td>
                            <?php echo $std->institution; ?>
                        </td>
                        <td>
                            <?php echo $std->year_passed; ?>
                        </td>
                        <td>
                            <?php echo $std->specialization; ?>
                        </td>
