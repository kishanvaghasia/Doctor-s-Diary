<?php
	...
	$search_q = "SELECT `first_name`, `middle_name`, `last_name`, `date_of_birth`, `doctor_id`, `gender`, `reg_id_number`, `caste`, `religion`, `address`, `phone_number`, `zipcode`, `email_address`, `state`, `name_of_degree`, `institution`, `year_passed`, `specialization` FROM `doctor_master`  WHERE first_name LIKE '%".$dfname."%' ";
...
-->
 ...
 Doctor </b> </hr>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Doctor Search</h1>
			</div>
		</div><!--/.row-->
					...
					<div class="panel-body">
                        ...
                        <table data-toggle="table"   data-show-refresh="true" data-show-toggle="true" data-show-columns="true"  data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                            ...
                            <?php echo "<tr>";
						      ...
						      echo "<td>".$row['doctor_id']."</td>&nbsp&nbsp&nbsp&nbsp";
                              
                                
                    
						      echo "<td>".$row['first_name']."</td>&nbsp&nbsp&nbsp&nbsp";
                    
                         
                        
                    
						      echo "<td>".$row['last_name']."</td>&nbsp&nbsp&nbsp&nbsp";
                            echo "<td>"; ?><a href='dview2.php?id=<?php echo $row['doctor_id']; ?>'>&nbsp;&nbsp;<svg  width="20" height="20" ><use xlink:href="#stroked-monitor"/></svg></a> <?php echo "</td>";
					           echo "</tr>";
